...
class BotFrameTranslator(object):
    ...
    def __init__(self):
        ...
        self.pose_sub = rospy.Subscriber("/vrpn_client_node/<name of robot>/pose", PoseStamped, self.pose_callback)
    ...
    def pose_callback(self, msg):
        ...
        self.br.sendTransform((x_nwu,y_nwu,z_nwu),self.pose.orientation,rospy.Time.now(),'world','base_link_truth')
